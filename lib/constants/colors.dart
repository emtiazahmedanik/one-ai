...
class AppColors {
  static Color themeColor = Color.fromARGB(255, 6, 57, 112);
  static Color screenColor = Color.fromARGB(255, 20, 0, 32);
  static Color appDefaultColor = getMaterialColor(screenColor);
  static Color appThemeColor = getMaterialColor(themeColor);
